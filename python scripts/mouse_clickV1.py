...
CLICK_FLICK_THRESHOLD = 4.0  # Change in acceleration for a flick
        ...
        if ser.in_waiting > 0:
            ...
            if "Accel" in line:
                ...
                if (current_time - last_click_time) > DEBOUNCE_TIME:
                    ...
                    if delta_x > CLICK_FLICK_THRESHOLD or delta_y > CLICK_FLICK_THRESHOLD:
                        pyautogui.click()  # Perform a mouse click
                        last_click_time = current_time  # Update the last click timestamp
                        print(f"Click detected with flick (ΔX: {delta_x}, ΔY: {delta_y})")
